/**
 * City Page: Best Car Loans After Bankruptcy in Chicago, IL (2026)
 * City: Chicago, IL | Page Type: car loans after bankruptcy
...
const TITLE = "Best Car Loans After Bankruptcy in Chicago, IL (2026)";
const H1 = "Best Car Loans After Bankruptcy in Chicago, IL";
const DESC = "Car loans after bankruptcy in Chicago, IL. Chapter 7 or Chapter 13 \u2014 discharged or active. Lenders in Cook County that approve post-bankruptcy borrowers.";
const INTRO = "Getting a car loan after bankruptcy in Chicago, IL is more achievable than most people think. Whether your Chapter 7 was discharged last month or your Chapter 13 is still active, lenders serving Cook County specialize in post-bankruptcy auto financing. In fact, a fresh bankruptcy discharge can sometimes work in your favor \u2014 your debt-to-income ratio is lower and lenders know you can't file again for years.";
const CITY = "Chicago";
const STATE = "IL";
...
export default function CityChicagoIlCarLoansAfterBankruptcy() {
  useSEO({
    ...
    description: "Car loans after bankruptcy in Chicago, IL. Chapter 7 or Chapter 13 \u2014 discharged or active. Lenders in Cook County that approve post-bankruptcy borrowers.",
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Car Loans After Bankruptcy", path: "/chicago-il/car-loans-after-bankruptcy" },
      ]),
    ],
  });
