/**
 * City Page: Best Bad Credit Auto Loans in Chicago, IL (2026)
 * City: Chicago, IL | Page Type: bad credit auto loans
...
const TITLE = "Best Bad Credit Auto Loans in Chicago, IL (2026)";
const H1 = "Best Bad Credit Auto Loans in Chicago, IL";
const DESC = "Compare the best bad credit auto loans in Chicago, IL. Lenders that approve credit scores 300\u2013600 with $500 down and proof of income.";
const INTRO = "Finding a bad credit auto loan in Chicago, IL doesn't have to mean getting taken advantage of. Whether you're driving I-90, I-94, I-290 to work or shuttling kids across Cook County, you need a reliable vehicle \u2014 and your credit score shouldn't stop you. We've reviewed every major lender serving Chicago residents and ranked them by approval rate, interest rate fairness, and customer experience.";
const CITY = "Chicago";
const STATE = "IL";
  ...
  useSEO({
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Bad Credit Auto Loans", path: "/chicago-il/bad-credit-auto-loans" },
      ]),
    ],
  });
