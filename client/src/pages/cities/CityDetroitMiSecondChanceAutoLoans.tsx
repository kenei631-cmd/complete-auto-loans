/**
 * City Page: Best Second Chance Auto Loans in Detroit, MI (2026)
 * City: Detroit, MI | Page Type: second chance auto loans
...
const TITLE = "Best Second Chance Auto Loans in Detroit, MI (2026)";
const H1 = "Best Second Chance Auto Loans in Detroit, MI";
const DESC = "Second chance auto loans in Detroit, MI for borrowers with bankruptcy, repossession, or collections. Fresh start financing specialists.";
const INTRO = "Second chance auto loans in Detroit, MI are built for borrowers who've been through the worst \u2014 bankruptcy, repossession, foreclosure, or serious delinquencies. Lenders serving Wayne County who specialize in second chance financing look at your current situation, not your past. We've ranked the most compassionate and fair second chance lenders in the Detroit metro.";
const CITY = "Detroit";
const STATE = "MI";
...
export default function CityDetroitMiSecondChanceAutoLoans() {
  useSEO({
    ...
    description: "Second chance auto loans in Detroit, MI for borrowers with bankruptcy, repossession, or collections. Fresh start financing specialists.",
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Second Chance Auto Loans", path: "/detroit-mi/second-chance-auto-loans" },
      ]),
    ],
  });
