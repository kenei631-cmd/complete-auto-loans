/**
 * City Page: Best Second Chance Auto Loans in Phoenix, AZ (2026)
 * City: Phoenix, AZ | Page Type: second chance auto loans
...
const TITLE = "Best Second Chance Auto Loans in Phoenix, AZ (2026)";
const H1 = "Best Second Chance Auto Loans in Phoenix, AZ";
const DESC = "Second chance auto loans in Phoenix, AZ for borrowers with bankruptcy, repossession, or collections. Fresh start financing specialists.";
const INTRO = "Second chance auto loans in Phoenix, AZ are built for borrowers who've been through the worst \u2014 bankruptcy, repossession, foreclosure, or serious delinquencies. Lenders serving Maricopa County who specialize in second chance financing look at your current situation, not your past. We've ranked the most compassionate and fair second chance lenders in the Phoenix metro.";
const CITY = "Phoenix";
const STATE = "AZ";
...
export default function CityPhoenixAzSecondChanceAutoLoans() {
  useSEO({
    ...
    description: "Second chance auto loans in Phoenix, AZ for borrowers with bankruptcy, repossession, or collections. Fresh start financing specialists.",
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Second Chance Auto Loans", path: "/phoenix-az/second-chance-auto-loans" },
      ]),
    ],
  });
