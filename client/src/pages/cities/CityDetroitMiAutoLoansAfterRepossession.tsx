/**
 * City Page: Best Auto Loans After Repossession in Detroit, MI (2026)
 * City: Detroit, MI | Page Type: auto loans after repossession
...
const DESC = "Auto loans after repossession in Detroit, MI. Previous repo on record? Lenders in Wayne County that specialize in post-repossession financing.";
const INTRO = "A previous repossession doesn't have to mean the end of your ability to finance a vehicle in Detroit, MI. Lenders serving Wayne County who specialize in post-repossession auto loans understand that circumstances change \u2014 job loss, divorce, medical emergencies. They evaluate your current income and stability, not the repo that's sitting on your credit report.";
const CITY = "Detroit";
const STATE = "MI";
