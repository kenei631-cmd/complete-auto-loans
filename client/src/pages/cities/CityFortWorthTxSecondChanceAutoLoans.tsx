/**
 * City Page: Best Second Chance Auto Loans in Fort Worth, TX (2026)
 * City: Fort Worth, TX | Page Type: second chance auto loans
...
const TITLE = "Best Second Chance Auto Loans in Fort Worth, TX (2026)";
const H1 = "Best Second Chance Auto Loans in Fort Worth, TX";
const DESC = "Second chance auto loans in Fort Worth, TX for borrowers with bankruptcy, repossession, or collections. Fresh start financing specialists.";
const INTRO = "Second chance auto loans in Fort Worth, TX are built for borrowers who've been through the worst \u2014 bankruptcy, repossession, foreclosure, or serious delinquencies. Lenders serving Tarrant County who specialize in second chance financing look at your current situation, not your past. We've ranked the most compassionate and fair second chance lenders in the Fort Worth metro.";
...
export default function CityFortWorthTxSecondChanceAutoLoans() {
  useSEO({
    ...
    description: "Second chance auto loans in Fort Worth, TX for borrowers with bankruptcy, repossession, or collections. Fresh start financing specialists.",
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Second Chance Auto Loans", path: "/fort-worth-tx/second-chance-auto-loans" },
      ]),
    ],
  });
