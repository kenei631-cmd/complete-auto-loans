/**
 * City Page: Best Second Chance Auto Loans in Charlotte, NC (2026)
 * City: Charlotte, NC | Page Type: second chance auto loans
...
const TITLE = "Best Second Chance Auto Loans in Charlotte, NC (2026)";
const H1 = "Best Second Chance Auto Loans in Charlotte, NC";
const DESC = "Second chance auto loans in Charlotte, NC for borrowers with bankruptcy, repossession, or collections. Fresh start financing specialists.";
const INTRO = "Second chance auto loans in Charlotte, NC are built for borrowers who've been through the worst \u2014 bankruptcy, repossession, foreclosure, or serious delinquencies. Lenders serving Mecklenburg County who specialize in second chance financing look at your current situation, not your past. We've ranked the most compassionate and fair second chance lenders in the Charlotte metro.";
...
export default function CityCharlotteNcSecondChanceAutoLoans() {
  useSEO({
    title: "Best Second Chance Auto Loans in Charlotte, NC (2026) | Complete Auto Loans",
    description: "Second chance auto loans in Charlotte, NC for borrowers with bankruptcy, repossession, or collections. Fresh start financing specialists.",
    canonical: "/charlotte-nc/second-chance-auto-loans",
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Second Chance Auto Loans", path: "/charlotte-nc/second-chance-auto-loans" },
      ]),
    ],
  });
