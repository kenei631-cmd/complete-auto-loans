/**
 * City Page: Best Auto Loans After Repossession in Chicago, IL (2026)
 * City: Chicago, IL | Page Type: auto loans after repossession
...
const TITLE = "Best Auto Loans After Repossession in Chicago, IL (2026)";
const H1 = "Best Auto Loans After Repossession in Chicago, IL";
const DESC = "Auto loans after repossession in Chicago, IL. Previous repo on record? Lenders in Cook County that specialize in post-repossession financing.";
const INTRO = "A previous repossession doesn't have to mean the end of your ability to finance a vehicle in Chicago, IL. Lenders serving Cook County who specialize in post-repossession auto loans understand that circumstances change \u2014 job loss, divorce, medical emergencies. They evaluate your current income and stability, not the repo that's sitting on your credit report.";
const CITY = "Chicago";
const STATE = "IL";
...
export default function CityChicagoIlAutoLoansAfterRepossession() {
  useSEO({
    ...
    description: "Auto loans after repossession in Chicago, IL. Previous repo on record? Lenders in Cook County that specialize in post-repossession financing.",
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Auto Loans After Repossession", path: "/chicago-il/auto-loans-after-repossession" },
      ]),
    ],
  });
