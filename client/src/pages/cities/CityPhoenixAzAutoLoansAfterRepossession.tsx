/**
 * City Page: Best Auto Loans After Repossession in Phoenix, AZ (2026)
 * City: Phoenix, AZ | Page Type: auto loans after repossession
...
const DESC = "Auto loans after repossession in Phoenix, AZ. Previous repo on record? Lenders in Maricopa County that specialize in post-repossession financing.";
const INTRO = "A previous repossession doesn't have to mean the end of your ability to finance a vehicle in Phoenix, AZ. Lenders serving Maricopa County who specialize in post-repossession auto loans understand that circumstances change \u2014 job loss, divorce, medical emergencies. They evaluate your current income and stability, not the repo that's sitting on your credit report.";
const CITY = "Phoenix";
const STATE = "AZ";
