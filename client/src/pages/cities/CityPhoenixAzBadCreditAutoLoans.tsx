/**
 * City Page: Best Bad Credit Auto Loans in Phoenix, AZ (2026)
 * City: Phoenix, AZ | Page Type: bad credit auto loans
...
const TITLE = "Best Bad Credit Auto Loans in Phoenix, AZ (2026)";
const H1 = "Best Bad Credit Auto Loans in Phoenix, AZ";
const DESC = "Compare the best bad credit auto loans in Phoenix, AZ. Lenders that approve credit scores 300\u2013600 with $500 down and proof of income.";
const INTRO = "Finding a bad credit auto loan in Phoenix, AZ doesn't have to mean getting taken advantage of. Whether you're driving I-10, I-17, Loop 101 to work or shuttling kids across Maricopa County, you need a reliable vehicle \u2014 and your credit score shouldn't stop you. We've reviewed every major lender serving Phoenix residents and ranked them by approval rate, interest rate fairness, and customer experience.";
const CITY = "Phoenix";
const STATE = "AZ";
...
export default function CityPhoenixAzBadCreditAutoLoans() {
  useSEO({
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Bad Credit Auto Loans", path: "/phoenix-az/bad-credit-auto-loans" },
      ]),
    ],
  });
