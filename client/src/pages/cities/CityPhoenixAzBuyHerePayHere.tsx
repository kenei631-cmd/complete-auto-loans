/**
 * City Page: Best Buy Here Pay Here Dealerships in Phoenix, AZ (2026)
 * City: Phoenix, AZ | Page Type: buy here pay here
...
const TITLE = "Best Buy Here Pay Here Dealerships in Phoenix, AZ (2026)";
const H1 = "Best Buy Here Pay Here Dealerships in Phoenix, AZ";
const DESC = "Find the best buy here pay here dealerships in Phoenix, AZ. No bank required \u2014 dealer finances directly. Approvals for any credit score.";
const INTRO = "Buy here pay here dealerships in Phoenix, AZ offer a direct path to vehicle ownership when traditional banks say no. The dealer acts as the lender, which means your approval is based on your income and down payment \u2014 not your credit score. We've ranked the top BHPH options serving Maricopa County and surrounding areas so you can drive off the lot today.";
const CITY = "Phoenix";
const STATE = "AZ";
...
export default function CityPhoenixAzBuyHerePayHere() {
  useSEO({
    ...
    description: "Find the best buy here pay here dealerships in Phoenix, AZ. No bank required \u2014 dealer finances directly. Approvals for any credit score.",
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Buy Here Pay Here Financing", path: "/phoenix-az/buy-here-pay-here" },
      ]),
    ],
  });
