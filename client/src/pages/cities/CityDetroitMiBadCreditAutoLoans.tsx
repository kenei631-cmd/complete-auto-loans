/**
 * City Page: Best Bad Credit Auto Loans in Detroit, MI (2026)
 * City: Detroit, MI | Page Type: bad credit auto loans
...
const DESC = "Compare the best bad credit auto loans in Detroit, MI. Lenders that approve credit scores 300\u2013600 with $500 down and proof of income.";
const INTRO = "Finding a bad credit auto loan in Detroit, MI doesn't have to mean getting taken advantage of. Whether you're driving I-75, I-94, I-96 to work or shuttling kids across Wayne County, you need a reliable vehicle \u2014 and your credit score shouldn't stop you. We've reviewed every major lender serving Detroit residents and ranked them by approval rate, interest rate fairness, and customer experience.";
const CITY = "Detroit";
const STATE = "MI";
