/**
 * City Page: Best Bad Credit Auto Loans in Tulsa, OK (2026)
 * City: Tulsa, OK | Page Type: bad credit auto loans
...
const TITLE = "Best Bad Credit Auto Loans in Tulsa, OK (2026)";
const H1 = "Best Bad Credit Auto Loans in Tulsa, OK";
const DESC = "Compare the best bad credit auto loans in Tulsa, OK. Lenders that approve credit scores 300\u2013600 with $500 down and proof of income.";
const INTRO = "Finding a bad credit auto loan in Tulsa, OK doesn't have to mean getting taken advantage of. Whether you're driving I-44, US-75, US-169 to work or shuttling kids across Tulsa County, you need a reliable vehicle \u2014 and your credit score shouldn't stop you. We've reviewed every major lender serving Tulsa residents and ranked them by approval rate, interest rate fairness, and customer experience.";
const CITY = "Tulsa";
const STATE = "OK";
...
export default function CityTulsaOkBadCreditAutoLoans() {
  useSEO({
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Bad Credit Auto Loans", path: "/tulsa-ok/bad-credit-auto-loans" },
      ]),
    ],
  });
