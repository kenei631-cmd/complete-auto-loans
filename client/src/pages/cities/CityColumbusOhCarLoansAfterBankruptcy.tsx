/**
 * City Page: Best Car Loans After Bankruptcy in Columbus, OH (2026)
 * City: Columbus, OH | Page Type: car loans after bankruptcy
...
const DESC = "Car loans after bankruptcy in Columbus, OH. Chapter 7 or Chapter 13 \u2014 discharged or active. Lenders in Franklin County that approve post-bankruptcy borrowers.";
const INTRO = "Getting a car loan after bankruptcy in Columbus, OH is more achievable than most people think. Whether your Chapter 7 was discharged last month or your Chapter 13 is still active, lenders serving Franklin County specialize in post-bankruptcy auto financing. In fact, a fresh bankruptcy discharge can sometimes work in your favor \u2014 your debt-to-income ratio is lower and lenders know you can't file again for years.";
const CITY = "Columbus";
const STATE = "OH";
