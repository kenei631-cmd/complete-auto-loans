/**
 * Columbus, OH — Car Loans After Bankruptcy in Columbus, OH
...
const faqs: CityFAQ[] = [
  { question: "Can I get a car loan after Chapter 7 bankruptcy in Columbus?", answer: "Yes. Many lenders in Columbus, OH approve car loans for borrowers who have filed Chapter 7 bankruptcy. You can often apply as soon as your bankruptcy is discharged, which typically takes 3–6 months." },
  { question: "Can I get a car loan during Chapter 13 bankruptcy in Columbus?", answer: "Yes, but you'll need permission from your bankruptcy trustee. Some lenders in Columbus specialize in financing for borrowers who are currently in an active Chapter 13 repayment plan." },
  { question: "How long after bankruptcy can I get a car loan in Columbus?", answer: "You can apply for a car loan immediately after your bankruptcy is discharged. However, waiting 12–24 months and rebuilding your credit can help you qualify for better interest rates." },
  { question: "What interest rates can I expect after bankruptcy in Columbus?", answer: "Post-bankruptcy auto loan rates in Columbus, OH typically range from 12% to 29.9% APR. Rates improve significantly after 12–24 months of on-time payments on your new loan." },
  { question: "How much down payment do I need after bankruptcy in Columbus?", answer: "Most post-bankruptcy lenders in Columbus require $500–$1,500 down. A larger down payment can help you qualify for a lower interest rate and better loan terms." }
];
...
export default function CityColumbusOhCarLoansAfterBankruptcy() {
  ...
  return (
    <CityServicePageTemplate
      title="Best Car Loans After Bankruptcy in Columbus, OH (2026) | Complete Auto Loans"
      h1="Best Car Loans After Bankruptcy in Columbus, OH"
      description="Find car loans after bankruptcy in Columbus, OH. Chapter 7 or Chapter 13 — lenders who approve discharged borrowers. Get matched in 2 minutes."
      intro="Getting a car loan after bankruptcy in Columbus, OH is more achievable than most people realize. Whether you filed Chapter 7 or Chapter 13, several lenders in our network specialize in post-bankruptcy auto financing and can approve you as soon as your case is discharged."
      city="Columbus"
      state="OH"
