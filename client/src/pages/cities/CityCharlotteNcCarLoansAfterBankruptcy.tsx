/**
 * Charlotte, NC — Car Loans After Bankruptcy in Charlotte, NC
...
const faqs: CityFAQ[] = [
  { question: "Can I get a car loan after Chapter 7 bankruptcy in Charlotte?", answer: "Yes. Many lenders in Charlotte, NC approve car loans for borrowers who have filed Chapter 7 bankruptcy. You can often apply as soon as your bankruptcy is discharged, which typically takes 3–6 months." },
  { question: "Can I get a car loan during Chapter 13 bankruptcy in Charlotte?", answer: "Yes, but you'll need permission from your bankruptcy trustee. Some lenders in Charlotte specialize in financing for borrowers who are currently in an active Chapter 13 repayment plan." },
  { question: "How long after bankruptcy can I get a car loan in Charlotte?", answer: "You can apply for a car loan immediately after your bankruptcy is discharged. However, waiting 12–24 months and rebuilding your credit can help you qualify for better interest rates." },
  { question: "What interest rates can I expect after bankruptcy in Charlotte?", answer: "Post-bankruptcy auto loan rates in Charlotte, NC typically range from 12% to 29.9% APR. Rates improve significantly after 12–24 months of on-time payments on your new loan." },
  { question: "How much down payment do I need after bankruptcy in Charlotte?", answer: "Most post-bankruptcy lenders in Charlotte require $500–$1,500 down. A larger down payment can help you qualify for a lower interest rate and better loan terms." }
];
...
export default function CityCharlotteNcCarLoansAfterBankruptcy() {
  useSEO({
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Car Loans After Bankruptcy in Charlotte, NC", path: "/charlotte-nc/car-loans-after-bankruptcy/" },
      ]),
      buildFAQSchema(faqs),
  ...
  return (
    <CityServicePageTemplate
      title="Best Car Loans After Bankruptcy in Charlotte, NC (2026) | Complete Auto Loans"
      h1="Best Car Loans After Bankruptcy in Charlotte, NC"
      description="Find car loans after bankruptcy in Charlotte, NC. Chapter 7 or Chapter 13 — lenders who approve discharged borrowers. Get matched in 2 minutes."
      intro="Getting a car loan after bankruptcy in Charlotte, NC is more achievable than most people realize. Whether you filed Chapter 7 or Chapter 13, several lenders in our network specialize in post-bankruptcy auto financing and can approve you as soon as your case is discharged."
      city="Charlotte"
      state="NC"
