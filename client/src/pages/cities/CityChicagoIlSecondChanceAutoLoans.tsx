/**
 * City Page: Best Second Chance Auto Loans in Chicago, IL (2026)
 * City: Chicago, IL | Page Type: second chance auto loans
...
const TITLE = "Best Second Chance Auto Loans in Chicago, IL (2026)";
const H1 = "Best Second Chance Auto Loans in Chicago, IL";
const DESC = "Second chance auto loans in Chicago, IL for borrowers with bankruptcy, repossession, or collections. Fresh start financing specialists.";
const INTRO = "Second chance auto loans in Chicago, IL are built for borrowers who've been through the worst \u2014 bankruptcy, repossession, foreclosure, or serious delinquencies. Lenders serving Cook County who specialize in second chance financing look at your current situation, not your past. We've ranked the most compassionate and fair second chance lenders in the Chicago metro.";
const CITY = "Chicago";
const STATE = "IL";
...
export default function CityChicagoIlSecondChanceAutoLoans() {
  useSEO({
    ...
    description: "Second chance auto loans in Chicago, IL for borrowers with bankruptcy, repossession, or collections. Fresh start financing specialists.",
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Second Chance Auto Loans", path: "/chicago-il/second-chance-auto-loans" },
      ]),
    ],
  });
