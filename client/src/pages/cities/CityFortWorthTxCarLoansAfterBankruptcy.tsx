/**
 * City Page: Best Car Loans After Bankruptcy in Fort Worth, TX (2026)
 * City: Fort Worth, TX | Page Type: car loans after bankruptcy
...
const TITLE = "Best Car Loans After Bankruptcy in Fort Worth, TX (2026)";
const H1 = "Best Car Loans After Bankruptcy in Fort Worth, TX";
const DESC = "Car loans after bankruptcy in Fort Worth, TX. Chapter 7 or Chapter 13 \u2014 discharged or active. Lenders in Tarrant County that approve post-bankruptcy borrowers.";
const INTRO = "Getting a car loan after bankruptcy in Fort Worth, TX is more achievable than most people think. Whether your Chapter 7 was discharged last month or your Chapter 13 is still active, lenders serving Tarrant County specialize in post-bankruptcy auto financing. In fact, a fresh bankruptcy discharge can sometimes work in your favor \u2014 your debt-to-income ratio is lower and lenders know you can't file again for years.";
...
export default function CityFortWorthTxCarLoansAfterBankruptcy() {
  useSEO({
    ...
    description: "Car loans after bankruptcy in Fort Worth, TX. Chapter 7 or Chapter 13 \u2014 discharged or active. Lenders in Tarrant County that approve post-bankruptcy borrowers.",
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Car Loans After Bankruptcy", path: "/fort-worth-tx/car-loans-after-bankruptcy" },
      ]),
    ],
  });
