/**
 * City Page: Best Second Chance Auto Loans in Tulsa, OK (2026)
 * City: Tulsa, OK | Page Type: second chance auto loans
...
const TITLE = "Best Second Chance Auto Loans in Tulsa, OK (2026)";
const H1 = "Best Second Chance Auto Loans in Tulsa, OK";
const DESC = "Second chance auto loans in Tulsa, OK for borrowers with bankruptcy, repossession, or collections. Fresh start financing specialists.";
const INTRO = "Second chance auto loans in Tulsa, OK are built for borrowers who've been through the worst \u2014 bankruptcy, repossession, foreclosure, or serious delinquencies. Lenders serving Tulsa County who specialize in second chance financing look at your current situation, not your past. We've ranked the most compassionate and fair second chance lenders in the Tulsa metro.";
const CITY = "Tulsa";
const STATE = "OK";
...
export default function CityTulsaOkSecondChanceAutoLoans() {
  useSEO({
    ...
    description: "Second chance auto loans in Tulsa, OK for borrowers with bankruptcy, repossession, or collections. Fresh start financing specialists.",
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Second Chance Auto Loans", path: "/tulsa-ok/second-chance-auto-loans" },
      ]),
    ],
  });
