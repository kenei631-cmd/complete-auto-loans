/**
 * City Page: Best Guaranteed Approval Auto Loans in Phoenix, AZ (2026)
 * City: Phoenix, AZ | Page Type: guaranteed approval auto loans
...
const TITLE = "Best Guaranteed Approval Auto Loans in Phoenix, AZ (2026)";
const H1 = "Best Guaranteed Approval Auto Loans in Phoenix, AZ";
const DESC = "Guaranteed approval auto loans in Phoenix, AZ for credit scores under 500. Steady income + down payment = approval. No exceptions.";
const INTRO = "Guaranteed approval auto loans in Phoenix, AZ are designed for borrowers who have been turned down everywhere else. If you have steady income and a down payment \u2014 typically $500 to $1,000 \u2014 lenders serving Maricopa County will work with you regardless of your credit score. We've ranked the most reliable guaranteed approval options in the Phoenix metro area.";
const CITY = "Phoenix";
const STATE = "AZ";
...
export default function CityPhoenixAzGuaranteedApprovalAutoLoans() {
  useSEO({
    title: "Best Guaranteed Approval Auto Loans in Phoenix, AZ (2026) | Complete Auto Loans",
    description: "Guaranteed approval auto loans in Phoenix, AZ for credit scores under 500. Steady income + down payment = approval. No exceptions.",
    ...
    schema: [
      ...
      buildBreadcrumbSchema([
        ...
        { name: "Guaranteed Approval Auto Loans", path: "/phoenix-az/guaranteed-approval-auto-loans" },
      ]),
    ],
  });
